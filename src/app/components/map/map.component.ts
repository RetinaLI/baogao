...
export class MapComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.option.visualMap.min = this.mapData[this.mapData.length - 1] ? this.mapData[this.mapData.length - 1].value : 0;
    this.option.visualMap.max = this.mapData[0] ? this.mapData[0].value : 100;
